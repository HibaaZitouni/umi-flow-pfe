...
const folders = [
  {
    ...
    light: '#dbeafe',
    textColor: '#1e3a8a',
    description: 'Cours, supports et ressources pédagogiques',
  },
  {
    id: 'emploi',
    ...
    light: '#d1fae5',
    textColor: '#064e3b',
    description: 'Consulter et gérer vos créneaux horaires',
  },
  {
    id: 'clubs',
    label: 'Clubs',
  ...
  },
  {
    ...
    light: '#fce7f3',
    textColor: '#831843',
    description: 'Suivi, notes et gestion des étudiants',
  },
];
...
const FolderStack = () => {
  ...
  const handleClick = (id) => {
    if (id === 'documents') navigate('/documents');
    else if (id === 'emploi') navigate('/emploi-du-temps');
    else if (id === 'clubs') navigate('/clubs');
    else if (id === 'evenements') navigate('/evenements');
    else if (id === 'bibliotheque') navigate('/bibliotheque');
    else if (id === 'etudiants') navigate('/etudiants');
    else alert(`Module "${id}" — bientôt disponible !`);
  };
